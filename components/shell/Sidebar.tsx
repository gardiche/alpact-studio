...
const elyseSub = [
  { href: "/elyse/business-plan", label: "Business Plan", icon: "📋" },
  { href: "/elyse/financements", label: "Financements", icon: "💶" },
];
  ...
  return (
    <aside className="w-[240px] flex-shrink-0 h-screen bg-surface border-r border-border flex flex-col sticky top-0">
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        ...
        {/* Elyse sub-navigation */}
        {(pathname.startsWith("/elyse/business-plan") || pathname.startsWith("/elyse/financements")) && (
            ...
            {elyseSub.map((sub) => (
              <Link
                ...
                className={`
                  ...
                  font-sans text-xs transition-all duration-150
                  ${isActive(sub.href)
                    ? "bg-bg text-fg font-semibold"
                    : "text-muted hover:bg-bg hover:text-fg"
                  }
