...
import { NotionIntegrationCard } from "@/components/integrations/notion/NotionIntegrationCard";
...
export default async function IntegrationsPage({
  ...
  searchParams: Promise<{ notion_error?: string; notion_connected?: string }>;
}) {
  const params = await searchParams;
  const notionError = params.notion_error ?? null;
    ...
    <div className="min-h-screen bg-bg p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4">
          <NotionIntegrationCard initialError={notionError} />
